...
jdc-gui:
	g++ -c -w ./src/gui/*.cpp `../wxWidgets-3.2.10/gtk-build/wx-config --cxxflags`
	gcc -c -w ./src/disassembler/*.c
	gcc -c -w ./src/decompiler/*.c
	gcc -c -w ./src/elf-handler/*.c
	gcc -c -w ./src/file-handler/*.c
	gcc -c -w ./src/jdc-str/*.c
	g++ -o ./bin/linux/x64/gui/jdc *.o `../wxWidgets-3.2.10/gtk-build/wx-config --libs all`

debug-jdc-gui:
	g++ -g -O0 -c -w ./src/gui/*.cpp `../wxWidgets-3.2.10/gtk-build/wx-config --cxxflags`
	gcc -g -O0 -c -w ./src/disassembler/*.c
	gcc -g -O0 -c -w ./src/decompiler/*.c
	gcc -g -O0 -c -w ./src/elf-handler/*.c
	gcc -g -O0 -c -w ./src/file-handler/*.c
	gcc -g -O0 -c -w ./src/jdc-str/*.c
	g++ -o ./bin/linux/x64/gui/debug-jdc *.o `../wxWidgets-3.2.10/gtk-build/wx-config --libs all`
