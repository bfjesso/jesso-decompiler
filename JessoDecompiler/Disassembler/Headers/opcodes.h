...
enum Mnemonic
{
	MOV, ADD, SUB, AND, OR, XOR, IMUL, IDIV, 
	
	AAA, AAD, AAM, AAS, ADC, ARPL,
	BOUND,
	CALL_FAR, CALL_NEAR, CDQ, CLC, CLD, CLI, CMC, CMP, CMPS, CMPXCHG, CPUID, CWDE,
	DAA, DAS, DEC, DIV,
	ENTER,
	...
	JA_SHORT, JB_SHORT, JBE_SHORT, JG_SHORT, JL_SHORT, JLE_SHORT, JNB_SHORT, JNL_SHORT, JNO_SHORT, JNP_SHORT, JNS_SHORT, JNZ_SHORT, JO_SHORT, JP_SHORT, JS_SHORT, JZ_SHORT, JMP_SHORT, JMP_FAR, JMP_NEAR, JRCXZ,
	...
	SAHF, SAR, SBB, SCAS, SETA, SETB, SETBE, SETG, SETL, SETLE, SETNB, SETNL, SETNO, SETNP, SETNS, SETNZ, SETO, SETP, SETS, SETZ, SHL, SHR, STC, STD, STI, STOS,
	TEST,
	WAIT,
	XCHG, XLAT,
