...
enum Mnemonic
{
	MOV, ADD, SUB, AND, OR, XOR, SHL, SHR, IMUL, IDIV,
	...
	SAHF, SAR, SBB, SCAS, SETA, SETB, SETBE, SETG, SETL, SETLE, SETNB, SETNL, SETNO, SETNP, SETNS, SETNZ, SETO, SETP, SETS, SETZ, STC, STD, STI, STOS,
	TEST,
	WAIT,
	XCHG, XLAT,
