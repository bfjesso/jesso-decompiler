...
wxBEGIN_EVENT_TABLE(CalculatorWindow, wxWindow)
EVT_CHECKBOX(FirstHexCheckBoxID, CalculatorWindow::CalculateResult)
EVT_TEXT(FirstValueInputID, CalculatorWindow::CalculateResult)
EVT_CHOICE(SelectOperationID, CalculatorWindow::CalculateResult)
EVT_CHECKBOX(SecondHexCheckBoxID, CalculatorWindow::CalculateResult)
EVT_TEXT(SecondValueInputID, CalculatorWindow::CalculateResult)
EVT_BUTTON(CopyHexResultID, CalculatorWindow::CopyHexResult)
...
void CalculatorWindow::CalculateResult(wxCommandEvent& e)
{
...
void CalculatorWindow::CopyHexResult(wxCommandEvent& e)
{
	CopyToClipboard(hexResultStr.c_str());
}

void CalculatorWindow::CopyDecResult(wxCommandEvent& e)
{
