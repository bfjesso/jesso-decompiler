...
enum Mnemonic
{
	...
	CALL_FAR, CALL_NEAR, CDQ, CLAC, CLC, CLD, CLI, CLTS, CMC, CMP, CMPS, CMPXCHG, CPUID, CBW, CWDE, CDQE, CVTPI2PS, CVTPI2PD, CVTSI2SS, CVTSI2SD,
	DAA, DAS, DEC, DIV,
	...
	RCL, RCR, RDMSR, RDPMC, RDTSC, RET_FAR, RET_NEAR, ROL, ROR,
