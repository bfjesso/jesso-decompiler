...
extern const char* mnemonicStrs[] =
{
	...
	"MOV", "VMOVUPS", "MOVUPS", "VMOVUPD", "MOVUPD", "VMOVSS", "MOVSS", "VMOVSD", "MOVSD", "MOVSX", "MOVD", "VMOVAPS", "MOVAPS", "VMOVAPD", "MOVAPD", "VMOVLPS", "MOVLPS", "VMOVHLPS", "MOVHLPS", "VMOVLPD", "MOVLPD", "VMOVSLDUP", "MOVSLDUP", "VMOVDDUP", "MOVDDUP", "VMOVHPS", "MOVHPS", "VMOVHPD", "MOVHPD", "VMOVSHDUP", "MOVSHDUP", "VMOVNTPS", "MOVNTPS", "VMOVNTPD", "MOVNTPD", "VMOVMSKPS", "MOVMSKPS", "VMOVMSKPD", "MOVMSKPD", "MOVS", "MOVSXD", "MOVZX", "MOVQ", "MOVDQA", "MOVDQU", "MOVNTI", "MOVQ2DQ", "MOVDQ2Q", "PMOVMSKB", "MOVNTQ", "MOVNTDQ", "MASKMOVQ", "MASKMOVDQU",
	"LEA",
	"ADD", "VADDPS", "ADDPS", "VADDPD", "ADDPD", "VADDSS", "ADDSS", "VADDSD", "ADDSD", "HADDPD", "HADDPS", "XADD", "PADDQ",
	"SUB", "VSUBPS", "SUBPS", "VSUBPD", "SUBPD", "VSUBSS", "SUBSS", "VSUBSD", "SUBSD", "HSUBPD", "HSUBPS",
	"AND", "VANDPS", "ANDPS", "VANDPD", "ANDPD", "VANDNPS", "ANDNPS", "VANDNPD", "ANDNPD", "PAND", "PANDN",
	"OR", "VORPS", "ORPS", "VORPD", "ORPD",
	"XOR", "VXORPD", "XORPD", "VXORPS", "XORPS",  "PXOR",
	"SHL", "SHLD",
	"SHR", "SHRD",
	...
	"CVTTPS2PI", "CVTTPD2PI", "VCVTTSS2SI", "CVTTSS2SI", "VCVTTSD2SI", "CVTTSD2SI", "CVTPS2PI", "CVTPD2PI", "VCVTSS2SI", "CVTSS2SI", "VCVTSD2SI", "CVTSD2SI", "VCVTPS2DQ", "CVTPS2DQ", "VCVTTPS2DQ", "CVTTPS2DQ", "CVTTPD2DQ", "CVTPD2DQ",
