...
enum Mnemonic
{
	...
	JMP_FAR, JMP_NEAR,
	JA_SHORT, JB_SHORT, JBE_SHORT, JG_SHORT, JL_SHORT, JLE_SHORT, JNB_SHORT, JGE_SHORT, JNS_SHORT, JNZ_SHORT, JS_SHORT, JZ_SHORT, JMP_SHORT,
	...
	JO_SHORT, JP_SHORT, JNO_SHORT, JNP_SHORT,
	...
	BOUND, BSF, BSR, BSWAP, BTC, BTR, BTS, BNDLDX, BNDMOV, BNDCL, BNDCU, BNDSTX, BNDMK, BNDCN,
	...
	SAHF, SBB, SCAS, STAC, STC, STD, STI, SYSCALL, SYSENTER, SYSEXIT, SYSRET,
	TZCNT,
