...
enum Mnemonic
{
	...
	CDQ, CWD, CQO, CLAC, CLC, CLD, CLI, CLTS, CMC, CMPS, CMPXCHG, CPUID,
	DAA, DAS, DIV,
	EMMS, ENCLS, ENCLU,
	...
	NOT,
	_OUT, OUTS,
	POPAD, POP_DS, POP_ES, POP_FS, POP_GS, POP_SS, POPF, PREFETCHW, PUSHAD, PUSH_CS, PUSH_DS, PUSH_ES, PUSH_FS, PUSH_GS, PUSH_SS, POPCNT, VPINSRW, PINSRW, VPEXTRW, PEXTRW,
