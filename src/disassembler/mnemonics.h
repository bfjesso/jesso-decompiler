...
enum Mnemonic
{
	...
	CMOVB, CMOVNB, CMOVZ, CMOVNZ, CMOVBE, CMOVA, CMOVS, CMOVNS, CMOVL, CMOVGE, CMOVLE, CMOVO, CMOVNO, CMOVG,
	SETA, SETB, SETBE, SETG, SETL, SETLE, SETNB, SETNL, SETNS, SETNZ, SETS, SETO, SETNO, SETZ,
	...
	JMP_FAR, JMP_NEAR,
	JA_SHORT, JB_SHORT, JBE_SHORT, JG_SHORT, JL_SHORT, JLE_SHORT, JNB_SHORT, JGE_SHORT, JNS_SHORT, JNZ_SHORT, JS_SHORT, JO_SHORT, JNO_SHORT, JZ_SHORT, JMP_SHORT,
	...
	VPUNPCKLBW, VPUNPCKLWD, VPUNPCKLDQ, PUNPCKLDQ, VPACKSSWB, PACKSSWB, VPACKUSWB, PACKUSWB, VPUNPCKHBW, PUNPCKHBW, VPUNPCKHWD, PUNPCKHWD, VPUNPCKHDQ, PUNPCKHDQ, VPACKSSDW, PACKSSDW, VPUNPCKLQDQ, PUNPCKLQDQ, VPUNPCKHQDQ, PUNPCKHQDQ,
	...
	VDIVPS, DIVPS, VDIVPD, DIVPD, VDIVSS, VDIVSD,
	...
	CLAC, CLC, CLD, CLI, CLTS, CMC, CMPS, CPUID,
	DAA, DAS,
	EMMS, ENCLS, ENCLU,
	...
	SAHF, SCAS, STAC, STC, STD, STI, SYSCALL, SYSENTER, SYSEXIT, SYSRET,
	TZCNT,
	...
	WAIT, WBINVD, WRMSR,
	XABORT, XBEGIN, XEND, XGETBV, XLAT, XSETBV, XTEST,
	...
	PMAXUB,
	VPAVGB, PAVGB, VPSRAW, PSRAW, VPSRAD, VPAVGW, PAVGW, VPMULHUW, PMULHUW, VPMULHW, PMULHW,
	...
	VPSUBB, PSUBB, VPSUBW, PSUBW, VPSUBD, PSUBD, VPSUBQ, PSUBQ, VPADDB, PADDB, VPADDW, PADDW, VPADDD,

	FXSAVE, FXRSTOR, LDMXCSR, XSAVE, XRSTOR, XSAVEOPT, CLFLUSH,
