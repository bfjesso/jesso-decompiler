...
extern const char* mnemonicStrs[] =
{
	...
	"BOUND", "BSF", "BSR", "BT", "BTC", "BTR", "BTS",
	"CALL FAR", "CALL NEAR", "CDQ", "CLAC", "CLC", "CLD", "CLI", "CLTS", "CMC", "CMP", "CMPS", "CMPXCHG", "CPUID", "CBW", "CWDE", "CDQE", "CVTPI2PS", "CVTPI2PD", "CVTSI2SS", "CVTSI2SD",
	"DAA", "DAS", "DEC", "DIV",
