...
const struct Opcode twoByteOpcodeMap[0x100][4] = // [byte][prefix] 0 - no prefix; 1 - 0x66; 2 - 0xF3; 3 - 0xF2  (not all opcodes have different definitions for each prefix or any of them)
{
	...
	{                                                                                           // 0x28
		{ MOVAPS, -1, Vps, Wps, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ MOVAPD, -1, Vpd, Wpd, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
	},
	{                                                                                           // 0x29
		{ MOVAPS, -1, Wps, Vps, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ MOVAPD, -1, Wpd, Vpd, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
	},
	{                                                                                           // 0x2A
		{ CVTPI2PS, -1, Vps, Qpi, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ CVTPI2PD, -1, Vpd, Qpi, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ CVTSI2SS, -1, Vss, Hss, Ey, NO_SUPERSCRIPT },
		{ CVTSI2SD, -1, Vsd, Hsd, Ey, NO_SUPERSCRIPT },
	},
	...
	{ WRMSR, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },           // 0x30
	{ RDTSC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },           // 0x31
	{ RDMSR, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },           // 0x32
	{ RDPMC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },           // 0x33
	{ SYSENTER, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },        // 0x34
	{ SYSEXIT, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },         // 0x35
	{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },     // 0x36
	{ GETSEC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },          // 0x37
	...
	{ BT, -1, Ev, Gv, NO_OPERAND_CODE, NO_SUPERSCRIPT },                                        // 0xA3
	{ SHLD, -1, Ev, Gv, Ib, NO_SUPERSCRIPT },                                                   // 0xA4
	{ SHLD, -1, Ev, Gv, CL_CODE, NO_SUPERSCRIPT },                                              // 0xA5
	...
	{ BTC, -1, Ev, Gv, NO_OPERAND_CODE, NO_SUPERSCRIPT },                                       // 0xBB
	{                                                                                           // 0xBC
		{ BSF, -1, Gv, Ev, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ TZCNT, -1, Gv, Ev, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
	},
	{                                                                                           // 0xBD
		{ BSR, -1, Gv, Ev, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ LZCNT, -1, Gv, Ev, NO_OPERAND_CODE, NO_SUPERSCRIPT },
		{ NO_MNEMONIC, -1, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_OPERAND_CODE, NO_SUPERSCRIPT },
	},
